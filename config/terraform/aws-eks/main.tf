...
resource "aws_internet_gateway" "this" {
  ...
  tags = merge(local.common_tags, {
    Name = "${var.environment_name}-eks-igw"
  })
}
...
resource "aws_subnet" "public" {
  ...
  tags = merge(local.common_tags, {
    Name                                          = "${var.environment_name}-eks-public-${count.index + 1}"
...
resource "aws_subnet" "private" {
  ...
  tags = merge(local.common_tags, {
    Name                                          = "${var.environment_name}-eks-private-${count.index + 1}"
...
resource "aws_eip" "nat" {
  domain = "vpc"
  tags = merge(local.common_tags, {
    Name = "${var.environment_name}-eks-nat-eip"
  })
}
...
resource "aws_nat_gateway" "this" {
  ...
  tags = merge(local.common_tags, {
    Name = "${var.environment_name}-eks-nat"
  })
